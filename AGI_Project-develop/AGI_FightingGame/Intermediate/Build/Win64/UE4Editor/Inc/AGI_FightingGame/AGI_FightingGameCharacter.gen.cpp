...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ECurrentState(ECurrentState_StaticEnum, TEXT("/Script/AGI_FightingGame"), TEXT("ECurrentState"), false, nullptr, nullptr);
	...
	{
		struct AGI_FightingGameCharacter_eventP1_TakeDamage_Parms
		{
			int32 Damage;
		};
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("P1_TakeDamage"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x04080401, 65535, sizeof(AGI_FightingGameCharacter_eventP1_TakeDamage_Parms));
			UProperty* NewProp_Damage = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Damage"), RF_Public|RF_Transient|RF_MarkAsNative) UUnsizedIntProperty(CPP_PROPERTY_BASE(Damage, AGI_FightingGameCharacter_eventP1_TakeDamage_Parms), 0x0010000000000080);
			ReturnFunction->Bind();
